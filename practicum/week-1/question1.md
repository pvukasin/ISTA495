...
3. Ctreat the following table:
  - table name: world
  - table columns: id, name, continent, population, area, migrants,fertility,medianage,urbanpopulation (id is a number and it is the primary key, name and continent are strings, area and population are numbers)
